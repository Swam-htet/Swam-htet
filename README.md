...
const swam = {
  ...
  company:  "MessageSpring",
  location: "Bangkok, Thailand",
  focus:    ["TypeScript", "NestJS", "Next.js", "PostgreSQL", "Kubernetes"],
  learning: ["AWS", "Terraform", "Ansible", "DevOps"],
  philosophy: "ship reliable systems, write code others can read",
};
```
...
Full-stack developer focused on building reliable, efficient web products. Mainly working with **TypeScript, Node.js, React, NestJS, PostgreSQL**.

I care about: clean APIs, good code review, honest documentation, and systems that don't page you at 3am.
...
```bash
$ cat current.todo
[*] deepening k8s + Terraform fluency
[*] writing more about systems I actually run in prod
```
...
[![Email](https://img.shields.io/badge/-Email-D14836?style=flat-square&logo=gmail&logoColor=white)](mailto:swamhtet129@gmail.com)
